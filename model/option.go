...
func InitOptionMap() {
	...
	common.OptionMap["AffRebateGroupWhitelist"] = common.AffRebateGroupWhitelist
	common.OptionMap["AffRebateFreezeDays"] = strconv.Itoa(common.AffRebateFreezeDays)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AffRebateGroupWhitelist":
		common.AffRebateGroupWhitelist = value
	case "AffRebateFreezeDays":
		common.AffRebateFreezeDays, _ = strconv.Atoi(value)
